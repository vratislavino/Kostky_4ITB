    ...
    public partial class Form1 : Form
    {
        ...
        private int CalculateLockedScore(List<Dice> dices) {
            ...
            if (dices.Count == 6) {
                ...
                if (countsList.Count(c => c == 1) == 6) // postupka, vöechny ËÌsla jsou tam 1x
                    return 2000;
                if (countsList.Count(c => c == 2) == 3) // dvojice, 3x jsem naöel dvojku
                    return 1000;
            }
        ...
        private bool IsValidCombination(List<Dice> dices, bool checkAll) {
            ...
            // ?? odebral jsem vöechny validnÌ kombinace
            return foundSome;
        }
